...
def merge_branches(
    ...
    Args:
        ...
        owner (Optional[str]): Repository owner or organization. Defaults to DEFAULT_OWNER from github_tools.
        merge_method (str): The merge method to use: 'merge', 'squash', or 'rebase'. Defaults to 'merge'.
                            ...
                            - 'rebase': Rebases the head branch onto the base branch
    
    Returns:
        Dict[str, Any]: Information about the merge including SHA of the resulting commit.
        
    Raises:
        RuntimeError: On API errors, merge conflicts, or unexpected failures.
    """
    from github_tools import _client, DEFAULT_OWNER
