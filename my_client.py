...
async def main():
    ...
    print("Enter an empty line to cancel the current query")
    print("-" * 50)
    ...
    try:
            ...
            async with ClientSession(*streams) as session:
                ...
                while True:
                    ...
                    if not response_data["success"]:
                        ...
                        continue  # Skip to next query instead of exiting
                    ...
                    if not sql_query:
                        print("No SQL query was generated. Try another query.")
                        continue  # Skip to next query instead of exiting
                ...
                # Disconnect when done with the loop
        ...
        if 'conn_id' in locals() and 'session' in locals():
            try:
                print("Disconnecting from database due to error...")
                await session.call_tool(
                    "disconnect",
                    {
                        "conn_id": conn_id
